...
import { BsFillPlayFill, BsSkipForwardFill, BsFillPauseFill, BsSkipBackwardFill } from "react-icons/bs";
    ...
    return(
        ...
        <div className='song' onClick={handleEvent}>
            ...
            <div className='songInfo'>
                <h2>{(props.name.length > 40) ? props.name.substring(0,40) : props.name}</h2>
            ...
            <div className='progressBar' value='0'></div>
...
Song.PropTypes ={
    ...
    forwardSelection: PropTypes.func.isRequired,
}
